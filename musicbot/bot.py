...
#######################################################################################################################
    ...
    def _gen_embed(self):
        ...
        e = discord.Embed()
        e.colour = 7506394
        e.set_footer(text=' {}'.format(BOTVERSION), icon_url='https://imgur.com/a/tMtzyWU')
        e.set_author(name=self.user.name, url='https://youtube.com/unknownprison', icon_url=self.user.avatar_url)
        return e
